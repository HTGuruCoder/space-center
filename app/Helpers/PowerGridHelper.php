...
class PowerGridHelper
{
    ...
    {
        return [
            'creator_first_name' => fn($model) => $model->creator?->first_name,
            'creator_last_name' => fn($model) => $model->creator?->last_name,
        ];
    }

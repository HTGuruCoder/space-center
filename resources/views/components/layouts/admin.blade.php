...
<head>
    ...
    <style>
        /* Ensure dropdown menus (nav/menu) appear above dashboard stats/cards */
        .dropdown .dropdown-content,
        .menu .dropdown-content,
        .dropdown-content {
            z-index: 99999 !important;
            position: absolute;
            /* reinforce absolute positioning */
        }
    </style>
</head>
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="hidden lg:flex lg:flex-col lg:w-64 bg-base-100 border-r border-base-300">
            ...
            <div class="flex-1 overflow-y-auto p-4">
                {{-- Desktop sidebar nav removed: navigation moved to top header for desktop. --}}
            </div>
        ...
        <div class="flex flex-col">
            ...
            <header class="bg-base-100 border-b border-base-300 sticky top-0 z-30">
                <div class="flex items-center justify-between px-4 py-3">
                    ...
                    {{-- Desktop horizontal nav: placed inside header so it stays fixed with the header --}}
                    <div class="hidden lg:flex lg:items-center lg:gap-2 lg:ml-4">
                        <x-layouts.partials.admin-nav-sidebar orientation="horizontal"
                ...
                {{-- Desktop horizontal nav is rendered after header to avoid scrollable area inside the header. --}}
            </header>

...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-base-200 overflow-x-hidden" x-data="{ drawer: false }" data-user-timezone="{{ auth()->user()?->timezone ?? config('app.timezone') }}">
            ...
            <div class="p-4">
                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center gap-3">
                        <x-icon name="mdi.rocket-launch" class="w-8 h-8 text-primary" />
                ...
                <x-layouts.partials.employee-nav-sidebar />
            </div>
        </div>
        ...
        <div class="flex min-h-screen">
            ...
            <aside class="hidden lg:flex lg:flex-col lg:w-64 bg-base-100 border-r border-base-300">
                ...
                <div class="p-6 border-b border-base-300">
                    <a href="{{ route('employees.dashboard') }}" class="flex items-center gap-3">
                        <x-icon name="mdi.rocket-launch" class="w-8 h-8 text-primary" />
                        <span class="text-xl font-bold">SpaceCenter</span>
                    </a>
                </div>

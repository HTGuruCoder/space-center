...
<div>
    ...
    <x-powergrid.delete-modal :title="__('Delete Absence')" :message="__('Are you sure you want to delete this absence record? This action cannot be undone.')" />

    {{-- Bulk Delete Confirmation Modal --}}
    <x-powergrid.bulk-delete-modal :title="__('Delete Selected Absences')" :message="__('Are you sure you want to delete the selected absence records? This action cannot be undone.')" />
</div>
